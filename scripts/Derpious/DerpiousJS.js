...
function sysage() {
    ...
    if (mass > 0.9) {
        ...
        var bigstarrounded = (Math.round(bigstar * 10000) / 10000);
        ...
        var ysum = (y1 / 10) + (y2 / 100) + (y3 / 1000) + (y4 / 10000)
        var ytest = (Math.floor(Math.random() * 1000) + 1) / 1000;
        var smallstar = x * 2 + z - 2 + (y1 / 10) + (y2 / 100) + (y3 / 1000) + (y4 / 10000);
